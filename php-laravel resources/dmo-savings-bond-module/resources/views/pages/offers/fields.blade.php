<div class="row mb-3">
    ...
    <div id="div-offer_title" class="col-md-8">
        ...
        {!! Form::text('offer_title', null, ['id'=>'offer_title', 'class' => 'form-control', 'placeholder' => 'e.g. FGN Savings Bond March 2026']) !!}
    </div>

    <!-- Status Field -->
    <div id="div-status" class="col-md-4">
        <label for="status" class="form-label">Status <span class="text-danger">*</span></label>
        {!! Form::select('status', ['open' => 'Open', 'closed' => 'Closed', 'pending' => 'Pending'], null, ['id'=>'status', 'class' => 'form-select']) !!}
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div id="div-price_per_unit" class="col-md-4">
        ...
        <div class="input-group">
            ...
            {!! Form::number('price_per_unit', null, ['id'=>'price_per_unit', 'class' => 'form-control', 'min' => 0, 'step' => '0.01']) !!}
        </div>
    </div>
    ...
    <div id="div-max_units_per_investor" class="col-md-4">
        ...
        <div class="input-group">
            ...
            {!! Form::number('max_units_per_investor', null, ['id'=>'max_units_per_investor', 'class' => 'form-control', 'min' => 1]) !!}
        </div>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div id="div-tenor_years" class="col-md-4">
        ...
        <div class="input-group">
            ...
            {!! Form::number('tenor_years', null, ['id'=>'tenor_years', 'class' => 'form-control', 'min' => 1]) !!}
        </div>
    </div>
</div>