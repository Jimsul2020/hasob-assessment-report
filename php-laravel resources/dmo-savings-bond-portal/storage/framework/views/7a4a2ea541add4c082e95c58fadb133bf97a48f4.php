<script type="text/javascript">
    $(document).ready(function() {
        ...
        function <?php echo e($control_id); ?>_display_results(endpoint_url) {
            ...
            $('#<?php echo e($control_id); ?>-div-card-view').append(
                "<span class='text-center ma-20 pa-20'>Loading.....</span>");
            ...
            $.get(endpoint_url).done(function(response) {
                ...
                if (response != null && response.result_count == 0) {
                    $('#<?php echo e($control_id); ?>-div-card-view').empty();
                    $('#<?php echo e($control_id); ?>-div-card-view').append(
                        "<span class='text-center ma-20 pa-20' style='padding-bottom:100px'>No results found.</span>"
                    );
                }
                ...
                if (response != null && response.paginate && response.result_count > 0) {
                    ...
                    for (let pg = 1; pg <= response.pages_total; pg++) {
                        $("#<?php echo e($control_id); ?>-pagination").append(
                            `<li class="page-item"><a data-val='${pg}' data-type='pg' class='<?php echo e($control_id); ?>-pg pg-${pg} page-link' href='#'>${pg}</a></li>`
                        );
                        (current_page == pg) ? $('.pg-' + pg).addClass('cdv-current-page'): $('.pg-' +
                            pg).addClass('text-primary');
                    }
        ...
        $(document).on('keyup', "#<?php echo e($control_id); ?>-txt-search", function(e) {
            ...
            <?php echo e($control_id); ?>_display_results("<?php echo e($control_obj->getJSONDataRouteName()); ?>?st=" +
                search_term);
        });
        ...
        $(document).on('click', ".<?php echo e($control_id); ?>-grp", function(e) {
            ...
            <?php echo e($control_id); ?>_display_results("<?php echo e($control_obj->getJSONDataRouteName()); ?>?grp=" +
                group_term);
        ...
        $(document).on('click', ".<?php echo e($control_id); ?>-pg", function(e) {
            ...
            let search_term = $('#<?php echo e($control_id); ?>-txt-search').val();
            let query_string = "?pg=" + page_number;
            if (search_term && search_term.trim() !== '') {
                query_string += "&st=" + encodeURIComponent(search_term);
            }
            <?php echo e($control_id); ?>_display_results("<?php echo e($control_obj->getJSONDataRouteName()); ?>" +
                query_string);
        });
...
<?php /**PATH C:\Users\EliteBook 830 G6\Desktop\Projects\Backend-assessment-test\php-laravel resources\hasob-foundation-core-bs-5\src/../resources/views/cardview/card-view-js.blade.php ENDPATH**/ ?>