                        ...
                        <div class="col-lg-12 ma-10">
                            ...
                            <div id="div-show-txt-investor-primary-id">
                                <div class="row">
                                    ...
                                    <?php echo $__env->make('dmo-savings-bond-module::pages.investors.show_fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                            </div>
                            <div id="div-edit-txt-investor-primary-id">
                                <div class="row">
                                    <div class="col-lg-10 ma-10">
                                    <?php echo $__env->make('dmo-savings-bond-module::pages.investors.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', ".btn-show-mdl-investor-modal", function(e) {
        ...
        $.get( "<?php echo e(route('sb-api.investors.show','')); ?>/"+itemId).done(function( response ) {
    ...
    $(document).on('click', ".btn-delete-mdl-investor-modal", function(e) {
        ...
        swal({
                ...
                if (isConfirm) {
                    ...
                    let endPointUrl = "<?php echo e(route('sb-api.investors.destroy','')); ?>/"+itemId;
    ...
    $('#btn-save-mdl-investor-modal').click(function(e) {
        ...
        let actionType = "POST";
        let endPointUrl = "<?php echo e(route('sb-api.investors.store')); ?>";
        ...
        if (primaryId != "0"){
            actionType = "PUT";
            endPointUrl = "<?php echo e(route('sb-api.investors.update','')); ?>/"+primaryId;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\EliteBook 830 G6\Desktop\Projects\Backend-assessment-test\php-laravel resources\dmo-savings-bond-module\src/../resources/views/pages/investors/modal.blade.php ENDPATH**/ ?>