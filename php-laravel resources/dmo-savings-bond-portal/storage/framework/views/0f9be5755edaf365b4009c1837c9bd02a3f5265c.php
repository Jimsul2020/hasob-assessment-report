...
<div id="div-date_of_birth" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('date_of_birth', null, ['id'=>'date_of_birth', 'class' => 'form-control']); ?>
...
<div id="div-origin_geo_zone" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('origin_geo_zone', null, ['id'=>'origin_geo_zone', 'class' => 'form-control']); ?>
...
<div id="div-origin_lga" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('origin_lga', null, ['id'=>'origin_lga', 'class' => 'form-control']); ?>
...
<div id="div-address_street" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('address_street', null, ['id'=>'address_street', 'class' => 'form-control']); ?>
...
<div id="div-address_town" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('address_town', null, ['id'=>'address_town', 'class' => 'form-control']); ?>
...
<div id="div-address_state" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('address_state', null, ['id'=>'address_state', 'class' => 'form-control']); ?>
...
<div id="div-bank_account_name" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('bank_account_name', null, ['id'=>'bank_account_name', 'class' => 'form-control','minlength' => 2,'maxlength' => 100]); ?>
...
<div id="div-bank_account_number" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('bank_account_number', null, ['id'=>'bank_account_number', 'class' => 'form-control']); ?>
...
<div id="div-bank_name" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('bank_name', null, ['id'=>'bank_name', 'class' => 'form-control']); ?>
...
<div id="div-bank_verification_number" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('bank_verification_number', null, ['id'=>'bank_verification_number', 'class' => 'form-control']); ?>
...
<div id="div-national_id_number" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('national_id_number', null, ['id'=>'national_id_number', 'class' => 'form-control']); ?>
...
<div id="div-cscs_id_number" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('cscs_id_number', null, ['id'=>'cscs_id_number', 'class' => 'form-control']); ?>
...
<div id="div-chn_id_number" class="form-group">
    ...
    <div class="col-lg-9">
        <?php echo Form::text('chn_id_number', null, ['id'=>'chn_id_number', 'class' => 'form-control']); ?>

    </div>
</div><?php /**PATH C:\Users\EliteBook 830 G6\Desktop\Projects\Backend-assessment-test\php-laravel resources\dmo-savings-bond-module\src/../resources/views/pages/investors/fields.blade.php ENDPATH**/ ?>