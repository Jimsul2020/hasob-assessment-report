...
<div class="d-flex align-items-center mb-3">
    ...
    <div class="ms-2">
        <span id="spn_offer_status" class="badge bg-<?php echo e(isset($offer->status) && $offer->status == 'open' ? 'success' : (isset($offer->status) && $offer->status == 'closed' ? 'danger' : 'warning')); ?> px-3 py-2" style="font-size: 0.85rem;">
