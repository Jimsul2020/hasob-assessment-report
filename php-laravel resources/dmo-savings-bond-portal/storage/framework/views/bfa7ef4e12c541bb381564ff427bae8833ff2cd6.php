        ...
        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
            <div>
                <div class="d-flex align-items-center">
                    ...
                    <span class="badge bg-<?php echo e($statusColor); ?> ms-3 px-3 py-1" style="font-size: 0.8rem; letter-spacing: 0.5px;">
                        <?php echo e(ucfirst($data_item->status)); ?>

                    </span>
                </div>
                <p class="text-muted mb-0 mt-1" style="font-size: 0.85rem;">
                    Created <?php echo e(\Carbon\Carbon::parse($data_item->created_at)->format('l, jS M Y')); ?> (<?php echo \Carbon\Carbon::parse($data_item->created_at)->diffForHumans(); ?>)
                </p>
            </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-md-3">
                <div class="p-3 bg-light rounded h-100 text-center" style="border: 1px solid #f0f0f0;">
                    ...
                    <h5 class="mb-0 fw-bold text-dark"><?php echo e($data_item->tenor_years); ?> <?php echo e($data_item->tenor_years == 1 ? 'Year' : 'Years'); ?></h5>
                </div>
            </div>
        </div>
