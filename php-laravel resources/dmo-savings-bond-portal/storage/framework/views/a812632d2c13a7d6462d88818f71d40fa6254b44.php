                                ...
                                <div class="col-lg-11 ma-10">
                                    ...
                                    <div id="div-value" class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <?php echo Form::file('mdl-bulk-upload-offer-modal-file', ['class' => 'form-control', 'id'=>'mdl-bulk-upload-offer-modal-file']); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\EliteBook 830 G6\Desktop\Projects\Backend-assessment-test\php-laravel resources\dmo-savings-bond-module\src/../resources/views/pages/offers/bulk-upload-modal.blade.php ENDPATH**/ ?>